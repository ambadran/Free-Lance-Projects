...
silent only
silent tabonly
cd ~/freelance-projects/hospital_traversing_robot/Programming/station
...
wincmd w
argglobal
if bufexists("station.py") | buffer station.py | else | edit station.py | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 72 - ((13 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 72
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 319 - ((50 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 319
