...
void differential_control_forward(uint8_t distance_cm, uint8_t duty_cycle);
void differential_control_backward(uint8_t distance_cm, uint8_t duty_cycle);
void differential_control_right(uint8_t angle_deg, uint8_t duty_cycle);
void differential_control_left(uint8_t angle_deg, uint8_t duty_cycle);
